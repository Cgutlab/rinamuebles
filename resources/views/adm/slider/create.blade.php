...
<div class="contenido">
    <div class="col-12">
        ...
        <form method="POST"  enctype="multipart/form-data" action="{{action('adm\SliderController@store')}}">
            @csrf
                ...
                <div class="col">
                    <div class="input-group mb-3">
                        <div class="custom-file">
                            ...
                            <label class="custom-file-label" id="img_label" for="imagen">Seleccione (Tamaño recomendado: 1400x450px)</label>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row w-100">
                ...
                <div class="row w-100">
                    <div class="col">
                        <a href="{{ route('slider', $seccion) }}" class="btn btn-eliminar">Cancelar</a>
                    </div>
                    <div class="col">
