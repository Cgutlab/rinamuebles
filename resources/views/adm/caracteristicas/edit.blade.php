...
<div class="contenido">
    <div class="col s12">
        ...
        <form method="POST"  enctype="multipart/form-data" action="{{action('adm\CaracteristicaController@update', $caracteristica->id)}}">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="contenido" name="contenido"  rows="3">{{$caracteristica->contenido}}</textarea>
                    </div>
                </div>
            </div>              
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="input-group mb-3">
                        <div class="custom-file">
                            ...
                            <label class="custom-file-label" id="img_label" for="imagen">Seleccione la imagen (Tamaño recomendado: 57x59px)</label>
                        </div>
                    </div>
                    <div class="imagen_show">
                        <img class="img_show" src="{{ asset($caracteristica->imagen) }}" alt="">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="orden" name="orden"  aria-describedby="ordenHelp" placeholder="Ingrese el orden" value="{{ $caracteristica->orden }}">
                    </div>
                </div>
            </div>   
            <div class="row">
